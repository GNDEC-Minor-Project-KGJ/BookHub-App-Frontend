...
function ShoppingBill() {
  ...
  const userCart = JSON.parse(localStorage.getItem('cartProducts')) || [];
  ...
  const [couponName, setCouponName] = useState('');
    ...
    let discountOnCurrentProduct =
      (product.originalPrice - product.discountedPrice) * product.quantity || 50;
    totalDiscount = totalDiscount + discountOnCurrentProduct ||100;
    totalBill = totalBill + product.discountedPrice * product.quantity || product.originalPrice;
  });
